                ...
                <Accordion defaultActiveKey="0">
                    ...
                    <Accordion.Item eventKey="1">
                        ...
                        <Accordion.Body>
                            ...
                            4. 😖 차별 금지: 보호되는 특성(예: 인종, 성별, 나이, 성적 취향, 종교, 국적, 장애 등)을 근거로 타인을 선동하거나 편견을 갖거나 증오하지 않습니다.<br/>
                    ...
                    <Accordion.Item eventKey="3">
                        ...
                        <Accordion.Body>
                            1. 📹 영상 행위: 의도적으로 주의를 산만하게 하고, 부적절하고, 파괴적이고 공격적인 행동과 표현을 피하세요. 여기에는 의류, 배경, 필터, 타일 메시지 및 오디오(사용 가능한 경우)가 포함됩니다.<br/>
                        </Accordion.Body>
                    </Accordion.Item>
                </Accordion>
            </div>
